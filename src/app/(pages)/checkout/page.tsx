    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <ul className="space-y-4 mb-6">
        {items.map((item: CartItem) => (
          <li key={item.id} className="border rounded-md p-4 flex justify-between items-center">
      ...
      <div className="mb-6 text-right space-y-1">
        <div className="text-xl font-bold">Arvioitu kokonaissumma: {total.toFixed(2)} €</div>
